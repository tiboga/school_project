...
class Tasks(SqlAlchemyBase):
    ...
    user_id = sqlalchemy.Column(sqlalchemy.types.Integer, sqlalchemy.ForeignKey("users.id"))
    volunteer_id = sqlalchemy.Column(sqlalchemy.types.Integer, sqlalchemy.ForeignKey("users.id"))